...
export const MOCK_PRODUCTS: Product[] = [
  // ===== FEMALE FRAGRANCES =====
  {
    ...
    images: ['assets/images/Khamrah-lattafa.png'],
    sizes: [
      { ml: 30, price: 250 },
      { ml: 50, price: 380 },
      { ml: 100, price: 550 }
  ...
  },
  {
    ...
    images: ['assets/images/valentino.png'],
    sizes: [
      { ml: 30, price: 650 },
      { ml: 50, price: 920 },
      { ml: 100, price: 1350 }
  ...
  },
  {
    ...
    images: ['assets/images/Latafa-Hayati.jpg'],
    sizes: [
      { ml: 30, price: 220 },
      { ml: 50, price: 340 },
      { ml: 100, price: 500 }
  ...
  },
  {
    ...
    images: ['assets/images/9PM- Afnan.png'],
    sizes: [
      { ml: 30, price: 280 },
      { ml: 50, price: 420 },
      { ml: 100, price: 600 }
  ...
  // ===== MALE FRAGRANCES =====
  {
    ...
    images: ['assets/images/Ombre-Normade.png'],
    sizes: [
      { ml: 30, price: 1800 },
      { ml: 50, price: 2800 },
      { ml: 100, price: 4200 }
  ...
  },
  {
    ...
    images: ['assets/images/Imagination.jpg'],
    sizes: [
      { ml: 30, price: 1600 },
      { ml: 50, price: 2500 },
      { ml: 100, price: 3800 }
  ...
  },
  {
    ...
    images: ['assets/images/hawas-fire1.png'],
    sizes: [
      { ml: 30, price: 300 },
      { ml: 50, price: 450 },
      { ml: 100, price: 650 }
  ...
  },
  {
    ...
    images: ['assets/images/Tomford.png'],
    sizes: [
      { ml: 30, price: 900 },
      { ml: 50, price: 1400 },
      { ml: 100, price: 2100 }
    ...
    items: [
      {
        ...
        brand: 'Louis Vuitton',
        image: 'assets/images/Ombre-Normade.png',
        size: 100,
        quantity: 1,
        price: 4200,
        type: 'regular'
    ...
    items: [
      {
        ...
        productName: 'Khamrah',
        brand: 'Lattafa',
        image: 'assets/images/Khamrah-lattafa.png',
        size: 50,
        quantity: 2,
        price: 380,
        type: 'regular'
    ...
    items: [
      {
        ...
        brand: 'Tom Ford',
        image: 'assets/images/Tomford.png',
        size: 50,
        quantity: 1,
        price: 1400,
        type: 'regular'
    ...
    items: [
      {
        ...
        brand: 'Valentino',
        image: 'assets/images/valentino.png',
        size: 100,
        quantity: 1,
        price: 1350,
        type: 'pre_order'
    ...
    items: [
      {
        ...
        productName: 'Hawas',
        brand: 'Rasasi',
        image: 'assets/images/hawas-fire1.png',
        size: 100,
        quantity: 1,
        price: 650,
        type: 'pre_order'
      },
      {
        ...
        productName: '9PM',
        brand: 'Afnan',
        image: 'assets/images/9PM- Afnan.png',
        size: 50,
        quantity: 1,
        price: 420,
        type: 'regular'
