...
export const MOCK_PRODUCTS: Product[] = [
  // ===== FEMALE FRAGRANCES =====
  {
    ...
    images: ['assets/images/Khamarah-lattafa-1.png'],
    sizes: [
      { ml: 30, price: 250 },
      { ml: 50, price: 380 },
      { ml: 100, price: 550 }
  ...
  },
  {
    ...
    images: ['assets/images/Afnan-9pm-1.png'],
    sizes: [
      { ml: 30, price: 280 },
      { ml: 50, price: 420 },
      { ml: 100, price: 600 }
    ...
    items: [
      {
        ...
        productName: 'Khamrah',
        brand: 'Lattafa',
        image: 'assets/images/Khamarah-lattafa-1.png',
        size: 50,
        quantity: 2,
        price: 380,
        type: 'regular'
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        productName: '9PM',
        brand: 'Afnan',
        image: 'assets/images/Afnan-9pm-1.png',
        size: 50,
        quantity: 1,
        price: 420,
        type: 'regular'
