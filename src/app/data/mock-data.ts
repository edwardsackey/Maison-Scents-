...
export const MOCK_PRODUCTS: Product[] = [
  // ===== FEMALE FRAGRANCES =====
  {
    ...
    images: ['assets/images/Khamarah.jpg'],
    sizes: [
      { ml: 30, price: 250 },
      { ml: 50, price: 380 },
      { ml: 100, price: 550 }
  ...
  },
  {
    ...
    images: ['assets/images/Valentino.jpg'],
    sizes: [
      { ml: 30, price: 650 },
      { ml: 50, price: 920 },
      { ml: 100, price: 1350 }
  ...
  },
  {
    ...
    images: ['assets/images/Afann-9pm.jpg'],
    sizes: [
      { ml: 30, price: 280 },
      { ml: 50, price: 420 },
      { ml: 100, price: 600 }
  ...
  // ===== MALE FRAGRANCES =====
  {
    ...
    images: ['assets/images/Ombre-Normade.jpg'],
    sizes: [
      { ml: 30, price: 1800 },
      { ml: 50, price: 2800 },
      { ml: 100, price: 4200 }
  ...
  },
  {
    ...
    images: ['assets/images/Hawas.jpg'],
    sizes: [
      { ml: 30, price: 300 },
      { ml: 50, price: 450 },
      { ml: 100, price: 650 }
  ...
  },
  {
    ...
    images: ['assets/images/TomFord.jpg'],
    sizes: [
      { ml: 30, price: 900 },
      { ml: 50, price: 1400 },
      { ml: 100, price: 2100 }
    ...
    items: [
      {
        ...
        brand: 'Louis Vuitton',
        image: 'assets/images/Ombre-Normade.jpg',
        size: 100,
        quantity: 1,
        price: 4200,
        type: 'regular'
    ...
    items: [
      {
        ...
        productName: 'Khamrah',
        brand: 'Lattafa',
        image: 'assets/images/Khamarah.jpg',
        size: 50,
        quantity: 2,
        price: 380,
        type: 'regular'
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        productName: '9PM',
        brand: 'Afnan',
        image: 'assets/images/Afann-9pm.jpg',
        size: 50,
        quantity: 1,
        price: 420,
        type: 'regular'
